...
let scrollCheckSize = scrollCheck.getBoundingClientRect();
console.log(scrollCheckSize)
/**
 * При открытии страницы вставляем несколько постов
 */
function init() {
...
function getPostMarkup() {
    let num = parseInt(Math.random().toFixed(10) * 1000000000);
